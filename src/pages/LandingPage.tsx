...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      {mobileMenuOpen && (
        <div className="fixed top-20 left-0 right-0 z-50 bg-white border-b border-gray-200 shadow-lg md:hidden">
          <div className="flex flex-col p-4 space-y-4">
            <Button
              variant="ghost"
              className="justify-start hover:bg-[#4F46E5]/5 hover:text-[#4F46E5]"
              onClick={() => {
                navigate("/login");
                closeMobileMenu();
              }}
            ...
            <div className="border-t border-gray-100 pt-4 mt-4">
              {navItems.map((item, index) => (
                <Button
                  key={index}
                  variant="ghost"
                  className="w-full justify-start mb-2 hover:bg-[#4F46E5]/5 hover:text-[#4F46E5]"
                  onClick={() => {
